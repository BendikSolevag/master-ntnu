...
class Agent:
    def __init__(self, lr, input_dims, n_actions, fc1_dims=256, fc2_dims=256, gamma=0.99, n_step=5):
        self.gamma = gamma
        self.n_step = n_step
...
def main():
  ...
  # plot how long the agent waits before terminating
  plt.plot(episode_lengths)
  plt.xlabel("Episode")
  plt.ylabel("Steps before terminating")
  plt.show()
